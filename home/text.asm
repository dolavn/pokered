...
TMCharText::      db "מ”מ@"
TrainerCharText:: db "מאמן@"
PCCharText::      db "CP@"
RocketCharText::  db "רוקט@"
PlacePOKeText::   db "פוק@"
SixDotsCharText:: db "……@"
EnemyText::       db "היריב @"
...
; write text at (1,16)
	pop hl
	bccoord 18, 16 ; second line of dialogue text box
	jp NextTextCommand
...
; wait for button press; show arrow
	...
	ld a, "▼"
	ldcoord_a 1, 16 ; place down arrow in lower left corner of dialogue text box
	push bc
	call ManualTextScroll ; blink arrow and wait for A or B to be pressed
	pop bc
	ld a, " "
	ldcoord_a 1, 16 ; overwrite down arrow with blank space
	pop hl
	jp NextTextCommand
...
; below the first character column of the text box.
	ld a, " "
	ldcoord_a 1, 16 ; place blank space in lower left corner of dialogue text box
	call ScrollTextUpOneLine
	call ScrollTextUpOneLine
	pop hl
	bccoord 18, 16 ; second line of dialogue text box
